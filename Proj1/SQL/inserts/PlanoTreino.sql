...
insert into PlanoTreino (numPlano, dtCriacao, estado, idFuncionario, idCliente) values (5, '2022-08-24', 'ativo', 2, 4);
insert into PlanoTreino (numPlano, dtCriacao, estado, idFuncionario, idCliente) values (6, '2022-12-13', 'ativo', 2, 4);
